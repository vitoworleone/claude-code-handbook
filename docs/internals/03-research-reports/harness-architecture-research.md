...
| `src/cc-python-runtime/Source/cc/main.py` | 本地 Harness 入口 |
| `src/cc-python-runtime/Source/cc/core/query_engine.py` | QueryEngine 实现 |
| `src/cc-python-runtime/Source/cc/core/query_loop.py` | Runtime 核心 |
